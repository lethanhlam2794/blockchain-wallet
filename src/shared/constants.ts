...
export enum ENV_KEY {
  ...
  DEFAULT_CC_ADDRESS = 'DEFAULT_CC_ADDRESS',
  ...
  PARTNER_ACCESS_SECRET = 'PARTNER_ACCESS_SECRET',
}
...
export const ERR_CODE = {
  ...
  ACCOUNT_SUSPENDED: 'ACCOUNT_SUSPENDED'.toLowerCase(),
...
export const APP_ACTION = {
  ...
  BUY_CARD_ADMIN: 'BUY_CARD_ADMIN'.toLowerCase(),
  WITHDRAW_FROM_MUTUTAL_FUNDS: 'WITHDRAW_FROM_MUTUTAL_FUNDS'.toLowerCase(),
  PROVIDE_LIQUIDITY_AND_LOCK: 'PROVIDE_LIQUIDITY_AND_LOCK'.toLowerCase(),
  CRON_CONSTRUCT_COMMISSION_TREE:
    'CRON_CONSTRUCT_COMMISSION_TREE'.toLowerCase(),
  PAY_LEADERSHIP_COMMISSION: 'PAY_LEADERSHIP_COMMISSION'.toLowerCase(),
  GET_VPC_TO_USDT_PRICE: 'GET_VPC_TO_USDT_PRICE'.toLowerCase(),
  GET_BLOCKCHAIN_TRANSACTION: 'GET_TRANSACTION'.toLowerCase(),
  DECODE_BLOCKCHAIN_PARAMETER: 'DECODE_BLOCKCHAIN_PARAMETER'.toLowerCase(),
  VALIDATE_REFERRAL_DATA: 'VALIDATE_REFERRAL_DATA'.toLowerCase(),
  PAY_DIRECT_USDT_REWARD: 'PAY_DIRECT_USDT_REWARD'.toLowerCase(),
  ADMIN_LOGIN: 'ADMIN_LOGIN'.toLowerCase(),
  WITHDRAW_VPC_TO_VINACHAIN: 'WITHDRAW_VPC_TO_VINACHAIN'.toLowerCase(),
  WITHDRAW_VPC_TO_WEB3: 'WITHDRAW_VPC_TO_WEB3'.toLowerCase(),
  WITHDRAW_USDV_TO_WEB3: 'WITHDRAW_USDV_TO_WEB3'.toLowerCase(),
  TRANSFER_WVPC_FROM_POOL: 'TRANSFER_WVPC_FROM_POOL'.toLowerCase(),
  TRANSFER_USDV_FROM_POOL: 'TRANSFER_USDV_FROM_POOL'.toLowerCase(),
  TRANSFER_VPC_FROM_POOL: 'TRANSFER_VPC_FROM_POOL'.toLowerCase(),
  TRANSFER_WVPC_TO_PARTNER: 'TRANSFER_WVPC_TO_PARTNER'.toLowerCase(),
  PAY_PASSIVE_VPC_REWARD: 'PAY_PASSIVE_VPC_REWARD'.toLowerCase(),
  INIT_USER_BRANCH: 'INIT_USER_BRANCH'.toLowerCase(),
  HANDLE_USER_CLAIMED_VPC_REWARDS:
    'HANDLE_USER_CLAIMED_VPC_REWARDS'.toLowerCase(),
  BLOCKCHAIN_PAY_DIRECT_USDT_REWARD:
    'BLOCKCHAIN_PAY_DIRECT_USDT_REWARD'.toLowerCase(),
  VIEW_PARTNER_USER_INFO: 'VIEW_PARTNER_USER_INFO'.toLowerCase(),
  INIT_PARTNER_USER: 'INIT_PARTNER_USER'.toLowerCase(),
  VIEW_GAME_BALANCE: 'VIEW_GAME_BALANCE'.toLowerCase(),
  TOPUP_GAME_BALANCE: 'TOPUP_GAME_BALANCE'.toLowerCase(),
  WITHDRAW_GAME_BALANCE: 'WITHDRAW_GAME_BALANCE'.toLowerCase(),
  REQUEST_LOGIN_TOKEN: 'REQUEST_LOGIN_TOKEN'.toLowerCase(),
  GET_LIST_GAME: 'GET_LIST_GAME'.toLowerCase(),
  SEND_VIEW_USER_GAME_HISTORY_REQUEST:
    'SEND_VIEW_USER_GAME_HISTORY_REQUEST'.toLowerCase(),
  SEND_PAGINATE_PARTNER_USER_REQUEST:
    'SEND_PAGINATE_PARTNER_USER_REQUEST'.toLowerCase(),
  SEND_CONFIG_GAME_REQUEST: 'SEND_CONFIG_GAME_REQUEST'.toLowerCase(),
  SEND_GET_GAME_CONFIG_REQUEST: 'SEND_GET_GAME_CONFIG_REQUEST'.toLowerCase(),
  SEND_VIEW_GAME_ANALYTICS_REQUEST:
    'SEND_VIEW_GAME_ANALYTICS_REQUEST'.toLowerCase(),
  SEND_VIEW_USER_ANALYTICS_REQUEST:
    'SEND_VIEW_USER_ANALYTICS_REQUEST'.toLowerCase(),
  CRON_CONSTRUCT_VIP_ELIGIBILITY:
    'CRON_CONSTRUCT_VIP_ELIGIBILITY'.toLowerCase(),
  SEND_VIEW_BULK_CARD_PURCHASE_REQUEST:
    'SEND_VIEW_BULK_CARD_PURCHASE_REQUEST'.toLowerCase(),
  PAY_CARD_DIRECT_REWARDS: 'PAY_CARD_DIRECT_REWARDS'.toLowerCase(),
  PAY_CARD_LEADERSHIP_REWARDS: 'PAY_CARD_LEADERSHIP_REWARDS'.toLowerCase(),
  USER_STAKED_CARD: 'USER_STAKED_CARD'.toLowerCase(),
  SUBMIT_USER_KYC: 'SUBMIT_USER_KYC'.toLowerCase(),
  USER_CHANGE_REQUEST: 'USER_CHANGE_REQUEST'.toLowerCase(),
  REVIEW_USER_CHANGE_REQUEST: 'REVIEW_USER_CHANGE_REQUEST'.toLowerCase(),
  PAY_AIRDROP_BONUS: 'PAY_AIRDROP_BONUS'.toLowerCase(),
  REMOVE_WALLET: 'REMOVE_WALLET'.toLowerCase(),
  INITIALIZATION_ERROR: 'INITIALIZATION_ERROR'.toLowerCase(),
};
